...
# This is roadmap step 0 item 4 — the convention layer M4 builds on. The symbols never
...
Iwaki–Nakanishi dictionary statement the M4 bridge consumes. `vsyms[i]` is the Voros
